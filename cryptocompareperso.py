...
def get_historical_price_hour(coin, toTs, curr=CURR, limit=1000):
    return query_cryptocompare(URL_HIST_PRICE_HOUR.format(coin, format_parameter(curr), limit, int(toTs.timestamp())))
